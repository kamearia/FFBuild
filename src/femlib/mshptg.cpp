...
7: mshptg := 'bug dans l''algorithme pour retrouver la frontiŸre (Internal Bug mshfrt)';
8: mshptg := 'Une arte a forcer traverse trop de triangles (Internal Bug : mshfr1)';
9: mshptg := 'la frontiŸre est crois»e ';
10: mshptg := 'il y a un point qui est sur une arte frontiŸre';
