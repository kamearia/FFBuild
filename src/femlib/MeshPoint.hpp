...
class MeshPointBase { public:
  ...
  int d;
  int dHat;
  R3 Nt; //  surface Normal/curve tangent
...
// --------3D surface
    ...
    void set(const MeshS & aTh,const R3 &P2,const R2 & P_Hat,const TriangleS & aK,int ll,const R3 &NN,const R3 &NNt,int iedge,int VFF=0 )
    {
        P=P2;
        PHat.x=P_Hat.x;
        PHat.y=P_Hat.y;
    ...
    void set(const MeshS & aTh,const R3 &P2,const R2 & P_Hat,const TriangleS & aK,int ll,const R3 &EE,int iedge,int VFF=0 )
    {
        P=P2;
        PHat.x=P_Hat.x;
        PHat.y=P_Hat.y;
    ...
    void set(const  MeshS &aTh, const R3 &P2,const R3 & P_Hat,const TriangleS & aK,const R3 &NNt,const int ll, bool coutside=false)
    {
        P=P2;
        PHat=P_Hat;
        TS=&aK;
...
class MeshPoint : public MeshPointBase { public:
  ...
  void set(const MeshS & aTh,const R3 &P2,const R2 & P_Hat,const TriangleS &aK,int ll,const R3 &EE,int iedge) {
      MeshPointBase::set(aTh,P2,P_Hat,aK,ll,EE,iedge);
      }
...
inline static MeshPoint* MeshPointStack(Stack s) {
	void * p= static_cast<void **>(s)[MeshPointStackOffset];
	throwassert(p); 
	return static_cast<MeshPoint*>( p);
}
